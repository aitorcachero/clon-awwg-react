...
export default function NewsPage() {
  return (
    <>
      <header className="w-full relative mt-24 h-[420px] overflow-hidden object-center flex flex-col items-center justify-center mb-20">
      ...
      <section className="flex flex-col justify-center items-center gap-6">
        {news.map((section) => {
          return (
            <article className="w-[1200px] h-[315px] bg-white shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] flex flex-row">
              <main className="w-2/3 flex flex-col justify-center items-center px-10 gap-4">
                <a href={section.url}>
              ...
              <div className="w-1/3 flex justify-center items-center py-10">
                <img src={section.img} className="h-full w-full" />
              </div>
            </article>
          );
        })}
