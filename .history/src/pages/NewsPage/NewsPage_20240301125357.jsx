...
export default function NewsPage() {
  ...
  <footer class="flex flex-col justify-center items-center my-20">
    ...
    <div class="w-[1200px] flex flex-col">
      ...
      <a href="mailto:maria.maldonado@awwg.com" className="hover:underline" style={{color: '#355172'}}>maria.maldonado@awwg.com</a>
      <br>
      <p class="font-bold">AWWG Press office</p>
      <p>Weber Shandwick</p>
      <a href="mailto:AWWGpress@webershandwick.com" className= "hover:underline" style={{color: '#355172'}}>AWWGpress@webershandwick.com</a>
    </div>
  </footer>
    </>
  )
