        ...
        {news.map((section, i) => {
          return (
            <article
              ...
              key={i}
            >
              <main className="h-full lg:w-2/3 flex flex-col justify-end p-16 lg:justify-center items-center px-10 gap-4">
                <a href={section.url}>
              ...
              <div className="lg:w-1/3 flex justify-center items-center py-10 w-full">
                <img
                  src={section.img}
                  className="absolute lg:relative lg:h-full top-0  w-full"
                />
              </div>
            </article>
          );
