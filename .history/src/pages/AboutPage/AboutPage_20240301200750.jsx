    ...
    <>
      ...
      >
        ...
        <main className="lg:w-[1200px] lg:h-[400px] grid lg:grid-cols-3 text-white ">
          ...
          <article className="flex flex-col justify-center items-start overflow-hidden">
            <img src={bgOwnership} className="w-full h-full object-cover" />
          </article>
          <article className="flex flex-col justify-center items-start overflow-hidden">
            <img src={bgPassion} className="w-full h-full object-cover" />
          </article>
          <article className="flex flex-col justify-center items-start overflow-hidden">
            <img src={bgAdaptability} className="w-full h-full object-cover" />
          </article>
          <article
            className="flex flex-col justify-center items-start p-10"
            style={{ backgroundColor: '#2E5172' }}
