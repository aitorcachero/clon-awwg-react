  ...
  return (
    <>
      ...
      <section className="flex flex-col justify-center items-center w-full h-full">
        ...
        <main className="grid lg:grid-cols-2 gap-1">
          {executiveTeam.map((executive, i) => {
            return (
              <article
                key={i}
                className="flex flex-col lg:flex-row w-[625px] h-[315px]"
              >
                <div className="w-1/2">
                  <img src={executive.img} className="w-full" />
                </div>
                <main
                  className="flex flex-col justify-center items-center w-1/2 text-white gap-4 w-2/3"
                  style={{ backgroundColor: '#A0B6C2' }}
                >
                  <h2 className="text-3xl font-semibold">{executive.name}</h2>
