...
export default function SustainabilityPage() {
  return (
    <>
      <header className="w-full h-96 lg:h-[425px] overflow-hidden mt-24 flex justify-center items-center relative">
        <img src={sustainabilityBanner} className="object-center" />
        <h1
