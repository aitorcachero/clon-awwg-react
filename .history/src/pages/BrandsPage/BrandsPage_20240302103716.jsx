  ...
  return (
    <>
        ...
        return (
          ...
          >
            ...
            {brand.banner.map((brand, i) => {
              return (
                <div className="relative flex flex-col lg:flex-row" key={i}>
                  <img
                    src={brand.img}
                    className="w-[1200px] h-64 p-4 lg:p-0 lg:h-auto"
                  />
                  <a
                    href={brand.url}
                    target="_blank"
      ...
      {/* <section className="bg-white flex flex-col justify-center items-center mt-20 gap-10 mb-20">
        ...
        <div className="flex flex-col lg:flex-row w-full lg:w-[1200px] lg:h-[366px] gap-12 ">
          <div className="relative w-full h-full flex flex-col">
            <img
              src={tommyBrands}
              className="lg:w-[1200px] w-full h-96 p-4 lg:p-0 lg:h-auto"
            />
            <a
          ...
          <div className="relative h-full">
            <img
              src={ckBrands}
              className="w-[1200px] h-96 p-4 lg:p-0 lg:h-auto"
            />
            <a
