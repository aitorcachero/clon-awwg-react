...
export default function CareersPage() {
  return (
    <>
      ...
      <section className="flex flex-col lg:flex-row lg:h-[300px] p-[40px] gap-20 items-center justify-center mt-20 animate-slide-in-right">
        <img src={logoGratPlace} className="h-full" />
        <div className="flex flex-col w-[600px]">
          <p className="h-full text-center p-10 lg: p-0">
