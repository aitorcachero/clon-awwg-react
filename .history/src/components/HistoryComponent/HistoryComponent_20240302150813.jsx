      ...
      {history.map((element, i) => {
        return (
          <VerticalTimelineElement
            ...
            contentStyle={{ background: '#EAF2F7', color: '#fff' }}
            ...
            icon={element.icon}
          >
            <h3 className="vertical-timeline-element-title text-black text-end text-6xl">
              {element.date}
            </h3>
            <img src={element.img} style={{ backgroundColor: 'white' }} />
