        ...
        return (
          ...
          >
            <div className="w-full flex flex-col gap-2">
              <h3
                className={`vertical-timeline-element-title text-black  text-3xl text-start lg:${
                  i % 2 === 0 ? 'text-end' : 'text-start'
                }`}
                style={{ textAlign: i % 2 === 0 ? 'end' : 'start' }}
              >
                {element.date}
              </h3>
              <div
              ...
              <h4
                className={`vertical-timeline-element-subtitle text-black text-center lg:${
                  i % 2 === 0 ? 'text-end' : 'text-start'
                }`}
              >
                {element.text}
